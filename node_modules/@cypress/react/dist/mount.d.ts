 ...
 * @example
 ...
 ```
 **/
export declare const mount: (jsx: React.ReactNode, options?: MountOptions) => globalThis.Cypress.Chainable<import("cypress/types/bluebird")<globalThis.Cypress.Chainable<any>[]> | undefined>;
/**
 ...
 * })
 ```
 **/
export declare const createMount: (defaultOptions: MountOptions) => (element: React.ReactElement, options?: Partial<StyleOptions & MountReactComponentOptions> | undefined) => globalThis.Cypress.Chainable<import("cypress/types/bluebird")<globalThis.Cypress.Chainable<any>[]> | undefined>;
